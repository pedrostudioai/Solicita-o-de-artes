...
export const LINES: Record<UniformLine, LineDetails> = {
  [UniformLine.PRATA]: {
    ...
    shirtPrice: 42.90,
    shortsPrice: 32.00,
    description: 'Uma camisa com excelente custo-benefício. Ideal para quem busca economia sem abrir mão da qualidade.',
  ...
  [UniformLine.OURO]: {
    ...
    shirtPrice: 49.90,
    shortsPrice: 35.00,
    description: 'Excelente custo-benefício, porém com tecido melhor e acabamento superior.',
  ...
  [UniformLine.DIAMANTE]: {
    ...
    shirtPrice: 69.90,
    shortsPrice: 38.00,
    description: 'Muda totalmente a modelagem, deixando o visual muito profissional e exclusivo.',
  ...
  [UniformLine.EMPRESARIAL]: {
    ...
    shirtPrice: 49.90,
    shortsPrice: 0,
    description: 'Linha desenvolvida especificamente para atender empresas, eventos e outros grupos.',
    color: 'border-slate-800'
  }
};

export const CATEGORIES = [
  'Linha', 'Goleiro', 'Comissão Técnica', 'Atleta', 'Torcida', 'Staff / Eventos'
];

export const SIZES = ['PP', 'P', 'M', 'G', 'GG', 'XG', 'G1', 'G2', 'G3'];
...
export const Icons = {
  ...
  Diamond: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-gem"><path d="M6 3h12l4 6-10 13L2 9Z"/><path d="M11 3 8 9l3 13 3-13-3-6Z"/><path d="M2 9h20"/></svg>
  ),
  Briefcase: () => (
  ...
  Plus: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-plus"><path d="M12 5v14"/><path d="M12 12H5"/><path d="M19 12h-7"/></svg>
  ),
  Minus: () => (
